...
I should of course caution you that you might get the wrong answer if
you mutate the data as you're traversing it (so Don't Do That Then),
and that ordering by something other than @id ascending@ may be slower
in MySql.
