...
What triggered this rant, today, is rb-inotify, where the kernel
...
on github saying something similar, which I expect will be far more
likely to have a useful effect than ranting on this obscure blog.
But, yeah, I like ranting
