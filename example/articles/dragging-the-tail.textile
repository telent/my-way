...
backbone.js is at http://documentcloud.github.com/backbone/.  There's
a Ruby gem for using it with Rails: add @rails-backbone@ to your
Gemfile, and you get a handy set of generators wich write coffeescript
...
myself.  But I concede, signiicant whitespace is a valid personal
