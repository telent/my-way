...
Doing anything with Bluetooth inevitably turns into an exercise in yak
...
. The provided @rfcomm-client.c@ worked perfectly, modulo the obvious
...
in Ruby not in C.  Which turns out to be easier than we might expect.
Ruby's @socket@ library wraps the C socket interface suffiently
...
[...]
(gdb) break 21
Breakpoint 1 at 0x804865e: file c.c, line 21.
(gdb) run
Starting program: /home/dan/bc 

Breakpoint 1, main (argc=1, argv=0xbffff954) at c.c:22
...
The complete example code is at https://gist.github.com/2500413 and
...
display showing my heart rate and zone, (3) later, do some interesting
graphing and analysis stuff.  But your mileage may vary.
